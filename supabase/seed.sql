...
BEGIN
  ...
  VALUES
    ...
    (ayala_center_id, 'Apple Authorised',     'Electronics', '2nd Floor',    '2F-012', 'yellow', 7,  14),
    (ayala_center_id, 'National Book Store',  'Books',       '3rd Floor',    '3F-008', 'green',  2,  5),
  ...
  VALUES
    ...
    (central_bloc_id, 'Apple Authorised',    'Electronics', '1st Floor',    '1F-010', 'red',    9,  18),
    (central_bloc_id, 'National Book Store', 'Books',       '2nd Floor',    '2F-006', 'green',  1,  3),
  ...
  VALUES
    ...
    (sm_seaside_id, 'Apple Authorised',    'Electronics', '3rd Floor',   '3F-018', 'green',  2,  4),
    (sm_seaside_id, 'National Book Store', 'Books',       '2nd Floor',   '2F-010', 'green',  1,  2),
  ...
  VALUES
    ...
    (sm_city_id, 'Apple Authorised',    'Electronics', '2nd Floor',    '2F-008', 'yellow', 6,  13),
    (sm_city_id, 'National Book Store', 'Books',       '3rd Floor',    '3F-004', 'green',  2,  4),
