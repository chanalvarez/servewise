...
export default async function HomePage() {
  ...
  return (
    ...
    >
      ...
      {/* Scrollable body — hero + malls fill remaining height */}
      <div className="mx-auto flex min-h-0 w-full max-w-2xl flex-1 flex-col px-5">
        {/* Hero */}
        <div className="flex-shrink-0 pb-5 pt-5">
          <p className="mb-2 text-[10px] font-semibold uppercase tracking-[0.2em] text-indigo-400">
            Virtual Queue System · Cebu
          </p>
          <h1 className="text-[2.9rem] font-black leading-[0.92] tracking-tight text-white">
            Skip the<br />
          ...
          <div className="mt-4 flex items-center gap-1">
            {[
              ...
              <div key={step.n} className="flex items-center gap-1">
                {i > 0 && <span className="mx-0.5 text-white/15">→</span>}
                <div className="flex items-center gap-1 rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-1.5">
